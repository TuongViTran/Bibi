    ...
    <div class="box sidemenu">
        <div class="block" id="section-menu">
            ...
            <li><a class="menuitem">Danh mục sản phẩm </a>
               ...
               <li><a class="menuitem"> Danh sách</a>
                    <ul class="submenu">
                        <li><a href="titleslogan.php"> Bài Viết  </a></li>
                        <li><a href="social.php">Social Media</a></li>
                        <li><a href="copyright.php"> Nội dung</a></li>
                        
                    </ul>
                </li>
				
                 <li><a class="menuitem"> Tải trang</a>
                    <ul class="submenu">
                        <li><a>About Us</a></li>
                        <li><a>Contact Us</a></li>
                    </ul>
                </li>
				<li><a class="menuitem"> Chọn trình chiếu </a>
                    <ul class="submenu">
